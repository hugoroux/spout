...
abstract class WorkbookManagerAbstract implements WorkbookManagerInterface
{
     ...
     * @param float $height
     */
    public function setCurrentRowHeight(float $height)
    {
        $this->worksheetManager->setCurrentRowHeight($height);
    }
     ...
     * 
     * {@inheritDoc}
     * @see \Box\Spout\Writer\Common\Manager\WorkbookManagerInterface::mergeCells()
     */
    public function mergeCells(String $startIndex, String $endIndex)
    {
        $this->worksheetManager->mergeCells($this->getCurrentWorksheet(),$startIndex, $endIndex);
    }
